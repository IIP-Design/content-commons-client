...
const normalizeTypesData = project => {
  ...
  const normalizedTypeData = Object.create( {}, {
    __typename: { value: project.__typename },
    id: { value: project.id },
    createdAt: { value: project.createdAt },
    updatedAt: { value: project.updatedAt },
    projectTitle: { value: setProjectTitle( project ) },
    author: { value: `${project.author ? project.author.firstName : ''} ${project.author ? project.author.lastName : ''}` },
    team: { value: project.team ? project.team.name : '' },
    status: { value: project.status || '' },
    visibility: { value: project.visibility },
    thumbnail: { value: thumbnail() },
    categories: { value: getLangTaxonomies( project.categories ) }
  } );
