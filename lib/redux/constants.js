...
export const LOAD_DOCUMENT_USES_PENDING = 'load_document_uses_pending';
export const LOAD_DOCUMENT_USES_FAILED = 'load_document_uses_failed';
export const LOAD_DOCUMENT_USES_SUCCESS = 'load_document_uses_success';

export const LOAD_BUREAUS_OFFICES_PENDING = 'load_bureaus_offices_pending';
export const LOAD_BUREAUS_OFFICES_FAILED = 'load_bureaus_offices_failed';
export const LOAD_BUREAUS_OFFICES_SUCCESS = 'load_bureaus_offices_success';
...
export const SEARCH_LANGUAGE_UPDATE = 'search_language_update';
...
export const FILTER_CATEGORY_CHANGE = 'filter_category_update';
export const FILTER_COUNTRY_CHANGE = 'filter_country_update';
export const FILTER_DOCUMENT_USE_CHANGE = 'filter_document_use_update';
export const FILTER_BUREAU_OFFICE_CHANGE = 'filter_bureau_office_update';
export const FILTER_SOURCE_CHANGE = 'filter_source_update';
export const FILTER_POST_TYPE_CHANGE = 'filter_post_type_update';
export const FILTER_DATE_CHANGE = 'filter_date_change';
export const FILTER_FROM_DATE_CHANGE = 'filter_from_date_change';
export const FILTER_TO_DATE_CHANGE = 'filter_to_date_change';
