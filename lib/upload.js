 ...
 * @param {function} callback function to call to track upload progress
 */
...
/**
   ...
   * @param {String} path url to publicly available file
 */
...
/**
 * Takes an object and searches for all urls. Excludes any that have a http as
