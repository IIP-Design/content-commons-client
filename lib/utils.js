 ...
 * @param {string} string
 */
export const contentRegExp = string => /^.*share.*america\.gov.*$/.test( string );
...
export const getPathToS3Bucket = () => {
  ...
  return `https://s3.amazonaws.com/${publicRuntimeConfig.REACT_APP_AWS_S3_PUBLISHER_UPLOAD_BUCKET}`;
};
