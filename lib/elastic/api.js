...
/**
 * Get all recent type documents, descending order 
 * @param {*} type string
 */
...
/**
 * Get all document files for a package
 * @param {*} docIdsArray array
 */
export const packageDocumentsRequest = docIdsArray => axios
  .post( SEARCH, {
    body: bodybuilder()
      // .query( 'match', 'type', 'documents' )
      // .filter( 'terms', 'id', docIdsArray )
 ...
 * @param {*} postId
 */
export const getItemRequest = ( site, postId ) => axios
  .post( SEARCH, {
    body: bodybuilder()
      .size( 1 )
