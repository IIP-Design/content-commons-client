...
export const queryBuilder = store => {
  ...
  /**
   * We create separate query options for pkgs & non-pkgs since pkgs do not have a language field
   * Conditionally set query options based on type & authentication
   */
  const optionsObj = {
    nonPkg: {
      options: [],
