...
export const getElasticPkgDocs = async ( documents, user ) => {
  // On SSR (refresh results page while logged in),
  // user is undefined initially (ln. 8, useAPIRequest hook)
  // user is populated once gql query returns in useAuth & page then re-rendered
  if ( !user ) return;
